...
const styles = StyleSheet.create({
  ...
  subtitle: { width: '55%', height: 16, borderRadius: 4, marginTop: 4, marginBottom: 6 },
  caption: { width: '40%', height: 12, borderRadius: 4 },
  chip: { width: 120, height: 24, borderRadius: 4, marginRight: 8 }
});
