...
export function vmMapper(props: any): VM {
  return {
...
function getDetails(props: any): DetailsItemVM[] {
...
function getDetailsCodeItem(props: any): DetailsItemVM {
  return {
    key: 'code',
    name: 'Code',
...
function getDetailsCategoryItem(props: any): DetailsItemVM {
  return {
    key: 'category',
    name: 'Category',
