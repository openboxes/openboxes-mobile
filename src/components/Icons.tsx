...
export function ContainerIcon({ color = Theme.colors.primary, size = 32 }: { color?: string; size?: number }) {
  return <IconContainer width={size} height={size} fill={color} />;
}

export function LocationIcon({ color = Theme.colors.primary, size = 32 }: { color?: string; size?: number }) {
  return <IconLocation width={size} height={size} fill={color} />;
}

export function ProductIcon({ color = Theme.colors.primary, size = 32 }: { color?: string; size?: number }) {
  return <IconProducts width={size} height={size} fill={color} />;
}

export function QuantityIcon({ color = Theme.colors.primary, size = 32 }: { color?: string; size?: number }) {
  return <IconQuantity width={size} height={size} fill={color} />;
}

export function KeyboardIcon({ color = Theme.colors.primary, size = 32 }: { color?: string; size?: number }) {
  return <IconKeyboard width={size} height={size} fill={color} />;
}

export function ScanIcon({ color = Theme.colors.primary, size = 32 }: { color?: string; size?: number }) {
