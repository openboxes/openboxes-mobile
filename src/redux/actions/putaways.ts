...
export const SET_PUTAWAY_CANDIDATE_REMAINING_QUANTITY = 'SET_PUTAWAY_CANDIDATE_REMAINING_QUANTITY';
...
export function setPutawayCandidateRemainingQuantity(key: string, remainingQuantity: number) {
  return {
    type: SET_PUTAWAY_CANDIDATE_REMAINING_QUANTITY,
